...
import logoLight from "../assets/Group.svg";
import logoDark from "../assets/Group-black.svg";
    ...
    <div className="header-container">
      <header>
        <div className="logo-container">
          {theme==="dark" && <img className="logo" src={logoLight} alt="logo" style={{"width":'60px', "height":'60px'}} />}
          {theme==="light" && <img className="logo" src={logoDark} alt="logo" style={{"width":'60px', "height":'60px'}} />}
          {isBigScreen && <h3 className="logo-text">tasuku</h3>}{" "}
        </div>
